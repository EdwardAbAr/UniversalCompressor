...
## 1. Descarga y ejecución del proyecto

1. Clonar o descargar el repositorio desde la rama correspondiente (master).
2. Abrir la solución `Compressor.sln` con **Visual Studio** (versión 2022/2025 o similar, con el workload de “.NET desktop development” instalado).
3. Una vez abierto el proyecto:
      - Compilar el proyecto (Buil) para verificar que todo esté correcto.
...
- Windows con .NET instalado (aca se usa .NET 10.0).
...
- Un combo “Seleccionar Algoritmo” para elegir:
  - Huffman  
  - LZ77  
  - LZ78
- Botones:
